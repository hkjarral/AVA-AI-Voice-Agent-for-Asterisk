...
5. **Rotate the admin password** - The default admin password is randomly generated and forced to change at first login (as of v1a). Never run with an unrotated/shared admin credential.
