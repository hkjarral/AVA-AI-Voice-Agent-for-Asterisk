...
- Access Admin UI at `http://localhost:3003` (first-run password is printed to the admin_ui logs: `docker compose -p asterisk-ai-voice-agent logs admin_ui | grep PASSWORD`; you'll be required to change it at first login)
